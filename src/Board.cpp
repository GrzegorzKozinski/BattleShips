...
EField Board::getField(const Coordinate& coordinate) const
{
    ...
    log("getField: letterIdx is %d digitIdx is %d \n", idx.first, idx.second);
    return fields_[idx.first][idx.second]; // to test this method
}
